...
using System.Text;
using UnityEngine;
using Vamwpolf.Extensions.Guids;
...
namespace Vampwolf.Persistence
{
    ...
    {
        [SerializeField] public uint Part1;
        [SerializeField] public uint Part2;
        [SerializeField] public uint Part3;
        [SerializeField] public uint Part4;
